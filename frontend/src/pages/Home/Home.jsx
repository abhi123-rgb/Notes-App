    ...
    <>
      ...
      <div className='container mx-auto'>
        {allNotes.length > 0 ? (
          ...
          <EmptyCard
            imgSrc={isSearch ? NoDataFound : AddNotesImg}
            message={isSearch ?
              "Oops! No notes found matching your search."
              : "Start creating your first note! Click the 'Add' button to got down your thoughts, ideas and reminders, Let's get started!"} />
        )}
      </div>
